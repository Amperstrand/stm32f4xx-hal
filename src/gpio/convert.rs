...
use crate::pac::gpioa::{moder::MODER0_A, otyper::OT0_A};
...
pub trait PinMode: crate::Sealed {
    ...
    #[doc(hidden)]
    const MODER: Option<MODER0_A> = None;
    #[doc(hidden)]
    const OTYPER: Option<OT0_A> = None;
    #[doc(hidden)]
...
impl PinMode for Input {
    const MODER: Option<MODER0_A> = Some(MODER0_A::Input);
}

impl crate::Sealed for Analog {}
impl PinMode for Analog {
    const MODER: Option<MODER0_A> = Some(MODER0_A::Analog);
}

impl<Otype> crate::Sealed for Output<Otype> {}
impl PinMode for Output<OpenDrain> {
    const MODER: Option<MODER0_A> = Some(MODER0_A::Output);
    const OTYPER: Option<OT0_A> = Some(OT0_A::OpenDrain);
}

impl PinMode for Output<PushPull> {
    const MODER: Option<MODER0_A> = Some(MODER0_A::Output);
    const OTYPER: Option<OT0_A> = Some(OT0_A::PushPull);
}

impl<const A: u8, Otype> crate::Sealed for Alternate<A, Otype> {}
impl<const A: u8> PinMode for Alternate<A, OpenDrain> {
    const MODER: Option<MODER0_A> = Some(MODER0_A::Alternate);
    const OTYPER: Option<OT0_A> = Some(OT0_A::OpenDrain);
